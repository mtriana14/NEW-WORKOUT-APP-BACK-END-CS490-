...
from app.controllers.fitnessgoal_controller import create_fitnessgoal, delete_fitnessgoal, get_fitnessgoal, get_all_fitnessgoals, edit_fitnessgoal
...
fitnessgoal_bp.route('/fitnessgoal/<int:goal_id>', methods=["PATCH"])(edit_fitnessgoal)