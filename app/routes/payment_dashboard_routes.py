...
from app.controllers.payment_dashboard_controller import (
    get_payment_summary, get_coach_payment_summary
)
from app.controllers.payment_controller import get_all_payments, get_payment_stats
...
payment_dashboard_bp.route('/admin/payments/stats', methods=['GET'])(admin_required(get_payment_stats))