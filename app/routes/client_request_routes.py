...
from app.controllers.client_request_controller import send_request, get_pending_requests, respond_to_request, get_all_reqs
...
client_request_bp.route('/coach/<int:coach_id>/requests/all', methods=['GET'])(coach_required(get_all_reqs))
